...
func RunningSpentCalories(action int, weight, duration float64) float64 {
	...
	count := ((runningCaloriesMeanSpeedMultiplier * speed * runningCaloriesMeanSpeedShift) * weight / mInKm * duration * minInH) // Расход калорий при беге.
	return count
}
